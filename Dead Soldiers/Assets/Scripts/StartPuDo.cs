...
public class StartPuDo : MonoBehaviour, TimerController
{
    ...
    [SerializeField] private Button startPuDoButton;
    ...
    */
    ...
    public void DisableALLplate()
    {
        ...
        startPuDoButton.interactable = false;
    }
    public void EnableALLplate()
    {
        StartCoroutine(WaitForMouseUp());
    }
        private System.Collections.IEnumerator WaitForMouseUp()
    {
        ...
        startPuDoButton.interactable = true;
